...
class MatchGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Match entity")
        ...
        .repeat(2) {
            ...
            .post("/api/matches")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "date":"2020-01-01T00:00:00.000Z", "status":null, "currentMinute":"0", "team1":"SAMPLE_TEXT", "team2":"SAMPLE_TEXT", "team1Score":"0", "team2Score":"0"}""")).asJSON
            .check(status.is(201))
